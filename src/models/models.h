...
struct llm_build_motif : public llm_graph_context {
  ...
  private:
    ggml_tensor * build_grouped_diff_attn(ggml_tensor *             input_cur,
                                          llm_graph_input_attn_kv * inp_attn,
                                          ggml_tensor *             wq,
                                          ggml_tensor *             wk,
                                          ggml_tensor *             wv,
    ...
    ggml_tensor * build_grouped_diff_attention_core(ggml_tensor * Q,
                                                    ggml_tensor * K,
                                                    ggml_tensor * V,
                                                    ggml_tensor * kq_mask,
                                                    ggml_tensor * lambda_q1,
    ...
    ggml_tensor * build_polynorm_ffn(ggml_tensor * cur,
    ...
    ggml_tensor * build_polynorm(ggml_tensor * x, ggml_tensor * w, ggml_tensor * b, int il) const;
};
