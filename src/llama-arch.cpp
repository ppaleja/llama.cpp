    ...
    switch (arch) {
        ...
        case LLM_ARCH_MOTIF:
            return {
                ...
                LLM_TENSOR_ROPE_FREQS,     LLM_TENSOR_ATTN_NORM,      LLM_TENSOR_ATTN_Q,
                LLM_TENSOR_ATTN_K,         LLM_TENSOR_ATTN_V,         LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_ATTN_ROT_EMBD,  LLM_TENSOR_ATTN_SUB_NORM,  LLM_TENSOR_ATTN_LAMBDA_Q1,
                LLM_TENSOR_ATTN_LAMBDA_K1, LLM_TENSOR_ATTN_LAMBDA_Q2, LLM_TENSOR_ATTN_LAMBDA_K2,
                LLM_TENSOR_FFN_NORM,       LLM_TENSOR_FFN_GATE,       LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_FFN_UP,         LLM_TENSOR_FFN_POLYNORM_W, LLM_TENSOR_FFN_POLYNORM_B,
            };
        case LLM_ARCH_GPTJ:
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    { LLM_TENSOR_FFN_POLYNORM_W,         { LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL }        },
    { LLM_TENSOR_FFN_POLYNORM_B,         { LLM_TENSOR_LAYER_REPEATING, GGML_OP_ADD }        },
